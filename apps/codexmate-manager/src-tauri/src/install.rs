pub use codexmate_core::install::{
...
pub fn install_entrypoints() -> InstallActionResult {
    codexmate_core::install::install_entrypoints(&InstallOptions::default())
}

pub fn uninstall_entrypoints(options: InstallOptions) -> InstallActionResult {
    codexmate_core::install::uninstall_entrypoints(&options)
}

pub fn repair_shortcuts() -> InstallActionResult {
    codexmate_core::install::repair_entrypoints(&InstallOptions::default())
}
