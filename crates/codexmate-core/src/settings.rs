...
pub struct BackendSettings {
    ...
    #[serde(rename = "codexWorktree", default)]
    pub codex_worktree: String,
}
...
fn merge_known_setting_fields(target: &mut Map<String, Value>, source: &Map<String, Value>) {
    ...
    if let Some(value) = source.get("codexWorktree").and_then(Value::as_str) {
        target.insert(
            "codexWorktree".to_string(),
            Value::String(value.to_string()),
        );
    }
}
...
mod tests {
    ...
    fn settings_default_matches_expected_behavior() {
        ...
        assert!(settings.codex_worktree.is_empty());
    }
    ...
    #[test]
    fn settings_deserialize_reads_codex_worktree() {
        let settings: BackendSettings =
            serde_json::from_str(r#"{"codexWorktree":"/Users/test/my-project"}"#).unwrap();
        assert_eq!(settings.codex_worktree, "/Users/test/my-project");
    }
    ...
    #[test]
    fn settings_store_save_roundtrip_preserves_codex_worktree() {
        let dir = temp_dir();
        let store = SettingsStore::new(dir.join("settings.json"));
        let settings = BackendSettings {
            codex_worktree: "/Users/test/work".to_string(),
        ...
        assert_eq!(loaded.codex_worktree, "/Users/test/work");
    }
