//! Import providers from Codex CLI Service (CCS) settings.
...
pub fn sync_linked_profiles_from_default_db(
    ...
    anyhow::bail!(
        "CCS import of relay profiles has been removed; use crate::router::config types instead"
    )
}
...
pub fn write_linked_profiles_to_default_db(
