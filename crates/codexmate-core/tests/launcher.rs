...
#[cfg(windows)]
use codexmate_core::launcher::{WindowsProcessControlStrategy, windows_process_control_strategy};
use codexmate_core::ports::select_platform_loopback_port_with;
use codexmate_core::proxy::has_proxy_environment;
...
async fn launch_lifecycle_runs_sync_before_launch_writes_success_and_shutdowns_on_exit() {
    ...
    let hooks = FakeHooks::new(events.clone())
        ...
        .with_launch_result(CodexLaunch::Process {
            ...
            wait_strategy: codexmate_core::launcher::ProcessWaitStrategy::TrackedChild,
